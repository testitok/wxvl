...
![](https://mmbiz.qpic.cn/mmbiz_png/nvJGLMmlzsHxcmt8UPgRPN00xSTIATZlfUiae4DZJMPWl1G1iaOg2kD98A0ib8H13CVJuPsicp5aSREDicOwRic83S5g/640?wx_fmt=png&from=appmsg "")  
...
```
友加畅捷管理系统 RepFile.ashx 文件上传漏洞友加畅捷管理系统 RepFile.ashx 文件读取漏洞友加畅捷管理系统 fw.asmx XXE漏洞友加畅捷管理系统 DataHandler.ashx XXE漏洞友加畅捷管理系统 picOnload 任意文件上传漏洞（后台）友加畅捷管理系统 ms_DBLis 未授权访问致信息泄露漏洞友加畅捷管理系统 GetZTList 未授权访问致信息泄露漏洞友加畅捷管理系统 Attachment.ashx 任意文件读取漏洞友加畅捷管理系统 downloadfile.ashx 任意文件读取漏洞
```  
